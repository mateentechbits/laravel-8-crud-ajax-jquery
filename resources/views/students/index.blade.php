            ...
            <div>
                <div class="container mt-6 flex justify-center mx-auto">
                    <div class="flex flex-col">
                        <div class="w-full">
                            <div class="border-b border-gray-200 rounded overflow-hidden shadow mb-3">
                                <h1 class="text-3xl text-center mb-3 text-blue-900 font-bold">Student Records</h1>
                                @if (session()->has('status'))
                                    <div x-data="{show:true}" x-init="setTimeout(()=>show=false,5000)" x-show="show"
                                        class="text-center mx-auto rounded-md w-60 p-1 dark:bg-gray-800 text-white mb-3">
